...
def get_quiz_questions():
    return {
        ...
        "Which nitrogenous bases are found in DNA?": "Adenine, Thymine, Cytosine, Guanine",
        "What type of bond holds the two strands of DNA together?": "Hydrogen bonds",
        "During DNA replication, which enzyme synthesizes the new strand by adding nucleotides?": "DNA Polymerase",
        "What is the function of Primase in DNA replication?": "Synthesizes RNA primers",
        "Which enzyme joins Okazaki fragments on the lagging strand?": "DNA Ligase",
        "What prevents the single-stranded DNA from reannealing during replication?": "Single-Strand Binding Proteins (SSBs)",
        "What is the central dogma of molecular biology?": "DNA → RNA → Protein",
        "Which process converts DNA into mRNA?": "Transcription",
        "What is the function of RNA Polymerase?": "Synthesizes mRNA from a DNA template",
        "Which process involves ribosomes reading mRNA to produce proteins?": "Translation",
        "What is the three-letter sequence on mRNA that codes for an amino acid?": "Codon",
        "What is the role of tRNA during translation?": "Delivers amino acids to the ribosome",
        "Which organelle is responsible for assembling proteins?": "Ribosome",
        "What is removed from pre-mRNA during RNA splicing?": "Introns",
        "Which molecules form the ribosome?": "rRNA and proteins",
        "Which phase of the cell cycle involves DNA replication?": "S phase",
        "During which mitotic phase do chromosomes align in the center of the cell?": "Metaphase",
        "What is the function of the spindle fibers in mitosis?": "Separate sister chromatids",
        "Which phase marks the beginning of mitosis?": "Prophase",
        "During which phase of mitosis does the nuclear envelope break down?": "Prophase",
        "What is the result of mitotic cell division?": "Two genetically identical daughter cells",
        "How many daughter cells are produced in meiosis?": "Four",
        "What is the purpose of crossing over during meiosis?": "Increases genetic diversity",
        "What are alternative forms of a gene called?": "Alleles",
        "Which Mendelian principle states that allele pairs separate during gamete formation?": "Law of Segregation",
        "What is the genetic makeup of an organism called?": "Genotype",
        "What is the physical expression of a trait called?": "Phenotype",
        "Which type of inheritance occurs when both alleles are equally expressed?": "Codominance",
        "Which nitrogenous base is found in RNA but not in DNA?": "Uracil",
        "What is the difference between DNA and RNA?": "DNA has deoxyribose and thymine, RNA has ribose and uracil",
        "Which phase of the cell cycle is the longest?": "Interphase",
        "What is a karyotype used for?": "Analyzing chromosome structure",
        "What happens during cytokinesis?": "The cytoplasm divides to form two daughter cells",
        "What is the role of the centromere?": "Links sister chromatids",
        "Which process produces gametes?": "Meiosis",
        "What is the end result of meiosis?": "Haploid cells with half the chromosome number",
    }
